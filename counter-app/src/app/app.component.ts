...
export class AppComponent {
  ...
  private readonly negotiateUrl = "https://gimfunctions.azurewebsites.net/api/negotiate";
  private readonly getCounterUrl = "https://gimfunctions.azurewebsites.net/api/GetCounter";
  private readonly updateCounterUrl = "https://gimfunctions.azurewebsites.net/api/UpdateCounter";
